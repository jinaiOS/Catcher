...
extension ChattingDetailViewController: InputBarAccessoryViewDelegate {
    ...
    func requestPush(message: Message) {
        ...
        let headers: HTTPHeaders = [
            ...
            "Authorization": "key=AAAALC2TxOI:APA91bGLfXGpt5SqYGFRqGYb0JEOTVV0pzmyDEm9IE-Vb9YKadHhraXs_0YKpDR6-yBnTBA_rWUA6vLAdeeMAE0C91AgCJRL5V3rh_aDH69dZg08n82LVSRZdz-Abb_ymOx7E8kigG7_"
        ]
