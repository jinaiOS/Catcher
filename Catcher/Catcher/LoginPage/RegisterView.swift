...
final class RegisterView: UIView{
    private lazy var emailLabel: UILabel = {
        LabelFactory.makeLabel(text: "이메일", font: ThemeFont.regular(size: 22),textAlignment: .left)
    }()
    private lazy var passwordLabel: UILabel = {
        LabelFactory.makeLabel(text: "비밀번호", font: ThemeFont.regular(size: 22),textAlignment: .left)
    }()
    private lazy var passwordConfirmLabel: UILabel = {
        LabelFactory.makeLabel(text: "비밀번호 확인", font: ThemeFont.regular(size: 22),textAlignment: .left)
    }()
